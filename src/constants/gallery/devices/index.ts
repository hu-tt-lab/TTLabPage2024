...
export const deviceImages: GalleryImage[] = [
  {
    src: "/images/gallery/devices/pmut.jpg",
    caption: {
  ...
  {
    src: "/images/gallery/devices/audiosensor.jpg",
    caption: {
  ...
  {
    src: "/images/gallery/devices/sensor_above.jpg",
    caption: {
      en: "Acoustic sensor",
      ja: "音響センサ",
    },
  ...
  {
    src: "/images/gallery/devices/developed_probe.jpg",
    caption: {
  ...
  {
    src: "/images/gallery/devices/film_electrode.jpg",
    caption: {
  ...
  {
    src: "/images/gallery/devices/flexible.jpg",
    caption: {
  ...
  {
    src: "/images/gallery/devices/microcoil.png",
    caption: {
  ...
  {
    src: "/images/gallery/devices/submilicoil.jpg",
    caption: {
